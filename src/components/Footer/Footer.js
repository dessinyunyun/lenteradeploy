...
export default function Footer() {
  ...
  return (
    <footer className="bg-nav-fot py-3 sm:px-10 px-2 w-full overflow-hidden flex flex-col items-center" id="contact">
      <div className="primary flex flex-col lg:flex-row  items-center lg:items-start lg:justify-around mt-5 w-full border-b border-slate-700 pb-6 pt-1">
        ...
        <div className="Contact-us sm:text-center text-center text-sm sm:text-lg sm:w-1/3 text-slate-300">
          <h5 className="font-semibold  lg:mt-0 mt-3">Contact Info:</h5>
          <div className="contact text-slate-400  lg:mt-3 ">
        ...
        <div className="address md:text-center text-center sm:text-lg text-sm sm:w-1/3 text-slate-300">
          <h5 className="font-semibold lg:mt-0 mt-3">Address:</h5>
          <div className="address text-slate-400 lg:my-3 ">
