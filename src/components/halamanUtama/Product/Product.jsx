  ...
  return (
    <div className="product-contain mt-14 flex flex-col  m-auto w-4/5" style={{ rowGap: `${5.5}px` }} id="product">
      <div className="grid md:grid-cols-3 sm:gap-x-1.5 gap-y-1.5 h-1/2 w-full" style={{ paddingRight: `${2.5}px`, paddingLeft: `${3}px` }}>
        ...
        >
          <Image src="https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/Conference_Room_Systems.png?size=Thumbnail" className="w-full h-full object-cover" alt="audio visual" layout="fill" />
        ...
        <div className="networkong-computer w-full box-border flex flex-col justify-center gap-y-1.5">
          ...
          >
            <Image src="https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/6372f7e07746ccd481b5082d_nasa-min.jpg?size=Thumbnail" className="w-full h-full object-cover" layout="fill" alt="audio visual" />
            <div className={`${showOverlay && "gradient-overlay"} absolute inset-0`}>
          ...
          >
            <Image src="https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/printer-computer-office-table_93675-3798.jpg?size=Thumbnail" className="w-full h-full object-cover" layout="fill" alt="audio visual" />
            <div className={`${showOverlay && "gradient-overlay"} absolute inset-0`}>
              <div className="text text-white absolute bottom-3 left-3 text-start text-base sm:text-xs lg:text-base">
