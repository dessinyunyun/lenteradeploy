  ...
  return (
    <div className="product-contain mt-14 flex flex-col  m-auto w-4/5" style={{ rowGap: `${5.5}px` }} id="product">
      <div
        ...
        style={{ paddingRight: `${2.5}px`, paddingLeft: `${3}px` }}
      >
        <div
        ...
        >
          <Image
            src="https://wp.lenterainovasi.co.id/wp-content/uploads/2023/05/WhatsApp-Image-2023-04-27-at-16.35.07-e1683959734516.jpeg?size=Original"
          ...
          <div className={`${showOverlay && 'gradient-overlay'} absolute inset-0`} id="audio-visual">
            <div className="text text-white absolute bottom-3 left-3 text-start text-base lg:text-xl">
              ...
              <p className="font-semibold m-0">
                Bring your ideas to life with our audio visual services that combine creativity and technology.
              </p>
            </div>
          </div>
        </div>
        <div className="networkong-computer w-full box-border flex flex-col justify-center gap-y-1.5">
          <div
            ...
            style={{
              height:
                props.sizeScreen === 'laptop' || props.sizeScreen === 'tablet'
                  ? `${networkingAndComputerHeight}px`
                  : '',
            }}
          >
            <Image
              src="https://wp.lenterainovasi.co.id/wp-content/uploads/2023/05/6372f7e07746ccd481b5082d_nasa-min-e1683959705302.jpg?size=Original"
              className="w-full h-full object-cover"
              layout="fill"
              alt="audio visual"
            />
            <div className={`${showOverlay && 'gradient-overlay'} absolute inset-0`}>
              <div className="text text-white absolute bottom-3 left-3 text-start text-base sm:text-xs lg:text-base">
                <h4>Networking</h4>
                <p className="font-semibold m-0">
                  Experience seamless and reliable connectivity with our advanced networking solution.
                </p>
              </div>
            </div>
          </div>
          <div
            ...
            ref={networkingAndComputer}
            style={{ height: `${networkingAndComputerHeight}px` }}
          >
            <Image
              src="https://wp.lenterainovasi.co.id/wp-content/uploads/2023/05/printer-computer-office-table_93675-3798-e1683959717790.jpg?size=Original"
              className="w-full h-full object-cover"
              layout="fill"
              alt="audio visual"
            />
            <div className={`${showOverlay && 'gradient-overlay'} absolute inset-0`}>
              <div className="text text-white absolute bottom-3 left-3 text-start text-base sm:text-xs lg:text-base">
                ...
                <p className="font-semibold m-0">
                  Our experienced team can provide you with computer and printer services that are customized to your
