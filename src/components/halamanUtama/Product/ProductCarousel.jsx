...
export default function Carousel(props) {
    ...
    listImg.map((item, index) => (
      <div className="relative h-fit" key={index}>
        <Image
          alt="product"
          // layout="fill"
          height={props.networkingAndComputerHeight}
          src={item.img}
          width={props.networkingAndComputerWidth}
          // style={{ width: `${props.networkingAndComputerWidth}px` }}
        />
  ...
  return (
    <div
      className={` app product-list`}
      // style={{ height: `${props.networkingAndComputerHeight}px` }}
    >
      <Slider
        // className=""
        dots={true}
        slidesToShow={props.sizeScreen == 'hp' ? 2 : 3}
        // slidesToShow={3}
        autoplay={true}
        autoplaySpeed={2000}
        infinite={true}
