...
const whyChooseUsData = [
  {
    icon: "https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/puzzle-piece.png?size=Woocommerce_gallery_thumbnail",
  ...
  {
    icon: "https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/diploma.png?size=Woocommerce_gallery_thumbnail",
    title: "Expertise",
    description: "Our team has years of experience in handling complex projects and delivering high-quality results.",
  },
  {
    icon: "https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/social-network.png?size=Woocommerce_gallery_thumbnail",
  ...
  {
    icon: "https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/calendar-clock.png?size=Woocommerce_gallery_thumbnail",
    title: "Timely Delivery",
    description: "Our team is dedicated to meeting deadlines and delivering results that exceed your expectations.",
  },
  {
    icon: "https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/rocket-1.png?size=Woocommerce_gallery_thumbnail",
    title: "Innovation",
  ...
  {
    icon: "https://lentera.aissed-projects.my.id/wp-content/uploads/2023/05/wallet.png?size=Woocommerce_gallery_thumbnail",
