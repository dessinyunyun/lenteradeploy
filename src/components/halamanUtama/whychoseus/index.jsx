...
const whyChooseUsData = [
  {
    ...
    description:
      'We provide tailored IT solutions that meet the unique needs of your business, maximizing efficiency and productivity.',
  },
  {
  ...
  },
  {
    ...
    description:
      'We prioritize customer satisfaction and work tirelessly to ensure that our solutions meet your expectations.',
  },
  {
  ...
  },
  {
    ...
    title: 'Innovation',
    description:
      'We stay up-to-date with the latest advancements in technology and strive to incorporate innovative solutions into our services.',
  },
  {
    icon: 'https://wp.lenterainovasi.co.id/wp-content/uploads/2023/05/wallet.png?size=Woocommerce_gallery_thumbnail',
    title: 'Competitive Pricing',
    description:
      'We offer competitive pricing for our services, ensuring that you receive high-quality IT solutions at an affordable cost.',
  },
];
...
export default function Index() {
  return (
    <div className="whychooseus-contain mt-20 flex flex-col gap-1.5 m-auto w-4/5" id="about">
      ...
      <div className="list grid md:grid-cols-3 grid-cols-2 gap-10">
